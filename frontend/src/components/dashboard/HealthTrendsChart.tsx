            ...
            <BarChart data={data} margin={{ top: 4, right: 4, left: -24, bottom: 0 }}>
              ...
              <Tooltip
                ...
                formatter={(v: number, name: string) =>
                  name === "sleep" ? [`${v}h`, "Duration"] : [`${v}`, "Quality"]
                }
              />
              <Bar dataKey="sleep" fill="#60a5fa" opacity={0.8} radius={[3, 3, 0, 0]} maxBarSize={16} />
            </BarChart>
          </ResponsiveContainer>
        </ChartCard>
        ...
        <ChartCard title="Body Battery" icon={Battery} iconColor="text-emerald-400" empty={!hasBattery}>
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 4, right: 4, left: -24, bottom: 0 }}>
              ...
              <Tooltip contentStyle={TOOLTIP_STYLE} formatter={(v: number) => [`${v}`, "Body Battery"]} />
